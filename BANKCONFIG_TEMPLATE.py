"""
Private backend template for SHAMSKAY BANK APP.
...
4. Keep BANKCONFIG.py out of Git.
"""

# Private backend file: BANKCONFIG.py
# This file is intentionally not included in the public Git repository.
